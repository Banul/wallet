...
#                     StockTrackingResponseSender.send_stock_info(StockTrackingStatus.StockTrackingStatus(ticker, 'NOT EXISTS'))
#
#                 for ticker in existing:
#                     StockTrackingResponseSender.send_stock_info(StockTrackingStatus.StockTrackingStatus(ticker, 'OK'))
#
...
#                 StockTrackingResponseSender.send_stock_info(StockTrackingStatus.StockTrackingStatus(ticker, 'FAILED'))
#
